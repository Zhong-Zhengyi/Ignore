...
from evals.metrics.semantic_accuracy_forget import (semantic_accuracy_forget,
)
from evals.metrics.superficial_forgetting import (
    superficial_forgetting,
)

from evals.metrics.semantic_accuracy_retain import (
    semantic_accuracy_retain
)
...
# Register Semantic Accuracy metrics
_register_metric(semantic_accuracy_retain)
_register_metric(semantic_accuracy_forget)
_register_metric(superficial_forgetting)
